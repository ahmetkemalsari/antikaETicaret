                    ...
                    <h2>Hakkımızda
                      <?php 
                        ...
                        <?php 
                            ...
                            $button = 'btn-success';
                        ?>
                        <small style="color:gray">Hakkımızda Kısmını Buradan Güncelleyebilirsiniz</small>
                        <?php 
                        }
                       ?>
                ...
                forcePasteAsPlainText: true
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 text-right">
                          <button  type="submit" name="hakkimizdaKaydet" class="btn <?php echo $button ?>">Güncelle</button>
                        </div>
                      </div>
