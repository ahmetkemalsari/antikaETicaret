                    ...
                    <div class="x_title">
                      <h2>Menü Ekleme Sayfasi
                        ...
                        if($_GET['durum']=='ok'){
                          ...
                          $button = 'btn-success';
                          ?>
                          <small style="color:gray">Sitenize Bu Sayfadan Yeni Menü Ekleyebilirsiniz</small>
                          <?php 
                        }
                        ?>
                    ...
                    <div class="x_content">
                      ...
                      <form id="demo-form2" action="../ayarlar/islem.php" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" placeholder="Menü Sıra Giriniz" name="menu_sira" id="first-name" required="required"  class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" placeholder="Menü Url Adresini Giriniz" name="menu_url"  id="first-name" required="required"  class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 text-right">
                            ...
                            <button  type="submit" name="menuKaydet" class="btn <?php echo $button ?>">Kaydet</button>
                          </div>
                        </div>
